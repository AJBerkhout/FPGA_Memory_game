...
# ACDS 16.1 196 win32 2021.04.22.21:16:54
# ----------------------------------------
...
# ----------------------------------------
# If my_altpll is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/my_altpll.vho"
}
